            ...
            <div className="relative rounded-2xl border border-[#1a3a6e]/30 bg-gradient-to-br from-[#0c1422] via-[#0e1118] to-[#0a0a0a] overflow-hidden">
              ...
              <div className="relative z-10 p-8 sm:p-12 lg:p-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                  ...
                  {/* Left: copy */}
                  <div>
                    <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#0b2e18] border border-[#164d28] text-[#4ade80] text-xs font-semibold mb-7">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#4ade80] animate-pulse" />
                      Available Now
                    </div>

                    <h2 className="font-heading text-4xl sm:text-5xl font-bold text-white tracking-tight mb-5 leading-[1.1]">
                      Customer Support Agent
                    </h2>

                    <p className="text-[#777777] text-lg leading-relaxed mb-8">
                    ...
                    <ul className="space-y-4">
                      {supportFeatures.map(({ icon: Icon, text }) => (
                        <li key={text} className="flex items-start gap-3.5">
                          <div className="w-7 h-7 rounded-md bg-[#0d1f3a] border border-[#1a3a6e]/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                            <Icon size={14} className="text-[#4a7fd4]" strokeWidth={2} />
                          </div>
                          <span className="text-[#888888] text-sm leading-relaxed">{text}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
