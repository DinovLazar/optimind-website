    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 mesh-gradient">
          ...
          <div className="absolute top-[28%] left-[18%] w-[480px] h-[480px] bg-[#1a3a6e]/14 rounded-full blur-[130px] animate-pulse-glow" />
          <div
            className="absolute bottom-[20%] right-[12%] w-[320px] h-[320px] bg-[#2563eb]/8 rounded-full blur-[90px] animate-pulse-glow"
            style={{ animationDelay: '2s' }}
          />
          <div
            className="absolute top-[10%] right-[30%] w-[200px] h-[200px] bg-[#1a3a6e]/8 rounded-full blur-[70px] animate-pulse-glow"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 pb-24 text-center">
          ...
          <h1 className="font-heading text-5xl sm:text-6xl lg:text-[72px] font-bold text-white leading-[1.08] tracking-tight mb-7 max-w-4xl mx-auto">
            AI-Powered Customer Support.{' '}
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-lg border border-[#282828] hover:border-[#383838] text-[#cccccc] hover:text-white font-medium transition-all duration-200 hover:bg-white/[0.03] text-sm"
            >
              Contact Us
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <AnimatedSection key={item.title} delay={item.delay}>
                <div className="h-full p-6 rounded-2xl border border-[#181818] bg-[#0e0e0e] hover:border-[#252525] transition-colors group">
                  <div className="w-10 h-10 rounded-lg bg-[#1a3a6e]/15 flex items-center justify-center mb-5 group-hover:bg-[#1a3a6e]/25 transition-colors">
                  ...
                  <p className="text-[#5a5a5a] text-sm leading-relaxed">{item.body}</p>
                </div>
              </AnimatedSection>
            ))}
          </div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0a] via-[#0c0f16] to-[#0a0a0a]" />
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] bg-[#1a3a6e]/7 rounded-full blur-[110px] pointer-events-none" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="text-center mb-14">
              ...
              <h2 className="font-heading text-4xl sm:text-5xl font-bold text-white tracking-tight mb-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <AnimatedSection key={item.title} delay={item.delay}>
                <div className="h-full p-6 rounded-2xl border border-[#181818] bg-[#0c0f16] hover:border-[#1a3a6e]/35 transition-all hover:shadow-[0_0_36px_rgba(26,58,110,0.14)] group card-glow">
                  <div className="w-10 h-10 rounded-lg bg-[#1a3a6e]/18 flex items-center justify-center mb-5 group-hover:bg-[#1a3a6e]/35 transition-colors">
                    <item.icon size={19} className="text-[#4a7fd4]" strokeWidth={1.8} />
                  </div>
                  <h3 className="font-heading font-semibold text-white text-[17px] leading-snug mb-2.5">
                    {item.title}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <AnimatedSection delay={0}>
              <Link href="/products" className="block h-full group">
                <div className="h-full p-8 rounded-2xl border border-[#181818] bg-[#0e0e0e] hover:border-[#1a3a6e]/45 transition-all hover:shadow-[0_0_44px_rgba(26,58,110,0.18)] cursor-pointer">
                  ...
                  <h3 className="font-heading text-2xl font-bold text-white mb-3 group-hover:text-[#6ba3e8] transition-colors">
            ...
            <AnimatedSection delay={0.12}>
              <div className="h-full p-8 rounded-2xl border border-[#141414] bg-[#0a0a0a] opacity-55">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#141414] border border-[#222222] text-[#444444] text-xs font-semibold mb-5">
                  Coming Soon
                </div>
                <h3 className="font-heading text-2xl font-bold text-[#3a3a3a] mb-3">
                ...
                <div className="flex items-center gap-1.5 text-[#333333] text-sm font-medium cursor-not-allowed">
            ...
            {[
              ...
              <AnimatedSection key={item.step} delay={item.delay}>
                <div className="text-center px-4">
                  <div className="w-[104px] h-[104px] rounded-full border border-[#1a3a6e]/25 bg-[#0c1220] flex items-center justify-center mx-auto mb-6 relative">
